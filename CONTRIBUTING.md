...
We do not currently accept external contributions. Please refrain from providing code changes or pull requests as we
are unable to accept them.

## Reporting Security Vulnerabilities

Follow the procedure described in [SECURITY.md](SECURITY.md) to report a potential security issue.
